...
Errors were found! Amusingly enough, the ```Dutch Defense: Classical Variation``` was being evaluated as a 'Classical' time control. Additionally, all the opening names were unknown, when this problem arose, due to the overwriting that would occur. Of the 30,000 initial games that I was exploring with, 113 encountered this error. Less than 1%, but certainly not negligible. 
