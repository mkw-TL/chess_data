(() => {
    ...
    hasInsufficientMaterial(color) {
      ...
      if (hordeNum === 1) {
        if (piecesNum === 1) {
          ...
          return !(piecesBishops(oppositeSquareColor(hordeBishopColor)) >= 2 || piecesBishops(oppositeSquareColor(hordeBishopColor)) >= 1 && pieces.pawn >= 1 || pieces.pawn >= 2);
        } else if (horde.knight === 1) {
          return !(piecesNum >= 4 && (pieces.knight >= 2 || pieces.pawn >= 2 || pieces.rook >= 1 && pieces.knight >= 1 || pieces.rook >= 1 && pieces.bishop >= 1 || pieces.knight >= 1 && pieces.bishop >= 1 || pieces.rook >= 1 && pieces.pawn >= 1 || pieces.knight >= 1 && pieces.pawn >= 1 || pieces.bishop >= 1 && pieces.pawn >= 1 || hasBishopPair(opposite(color)) && pieces.pawn >= 1) && (piecesBishops("dark") < 2 || piecesOfRoleNot(piecesBishops("dark")) >= 3) && (piecesBishops("light") < 2 || piecesOfRoleNot(piecesBishops("light")) >= 3));
        }
      } else if (hordeNum === 2) {
        if (piecesNum === 1) {
          return true;
          ...
          return !(pieces.pawn >= 1 || piecesBishops(oppositeSquareColor(hordeBishopColor)) >= 1 || piecesOfRoleNot(piecesBishops(hordeBishopColor)) >= 3);
        } else {
          return !(pieces.pawn >= 1 && piecesBishops(oppositeSquareColor(hordeBishopColor)) >= 1 || pieces.pawn >= 1 && pieces.knight >= 1 || piecesBishops(oppositeSquareColor(hordeBishopColor)) >= 1 && pieces.knight >= 1 || piecesBishops(oppositeSquareColor(hordeBishopColor)) >= 2 || pieces.knight >= 2 || pieces.pawn >= 2);
        }
      } else if (hordeNum === 3) {
  ...
  // node_modules/lichess-pgn-viewer/dist/translation.js
  ...
  // node_modules/lichess-pgn-viewer/dist/path.js
  var Path = class {
    constructor(path) {
      this.path = path;
  ...
  // node_modules/lichess-pgn-viewer/dist/game.js
  var Game = class {
  ...
  // node_modules/lichess-pgn-viewer/dist/pgn.js
  var State = class {
  ...
  // node_modules/lichess-pgn-viewer/dist/pgnViewer.js
  var PgnViewer = class {
  ...
  var pawn = (color) => (x1, y1, x2, y2) => diff(x1, x2) < 2 && (color === "white" ? y2 === y1 + 1 || y1 <= 1 && y2 === y1 + 2 && x1 === x2 : y2 === y1 - 1 || y1 >= 6 && y2 === y1 - 2 && x1 === x2);
  ...
  function isShort(dest, dests) {
    return (dest && dests.has(dest) && dests.get(dest).size > 1) === true;
  }
  ...
  // node_modules/lichess-pgn-viewer/dist/view/util.js
  ...
  var bind = (eventName, f, redraw, passive = true) => onInsert((el) => el.addEventListener(eventName, (e2) => {
    const res = f(e2);
    if (res === false)
      e2.preventDefault();
  ...
  // node_modules/lichess-pgn-viewer/dist/events.js
  ...
  // node_modules/lichess-pgn-viewer/dist/view/menu.js
  ...
  // node_modules/lichess-pgn-viewer/dist/view/side.js
  var renderMoves = (ctrl) => h("div.lpv__side", h("div.lpv__moves", {
    hook: {
      insert: (vnode2) => {
        const el = vnode2.elm;
        if (!ctrl.path.empty())
  ...
  var renderMove = (ctrl) => (move3) => h("move", {
    class: {
  ...
  // node_modules/lichess-pgn-viewer/dist/view/player.js
  ...
  // node_modules/lichess-pgn-viewer/dist/view/main.js
  function view(ctrl) {
  ...
  // node_modules/lichess-pgn-viewer/dist/config.js
  var defaults2 = {
    pgn: "*",
    fen: void 0,
    showPlayers: "auto",
...
${opts.pgn}`;
  ...
  // node_modules/lichess-pgn-viewer/dist/main.js
